...
class TuningConfig(BaseConfig):
    ...
    jitter_px: float = 0.5
    minus_end_target_length_mean: float = 0.0  # Fixed mean, usually 0
    ...
    def create_synthetic_config_from_trial(self, trial: Trial) -> SyntheticDataConfig:
        ...
        suggested_params["minus_end_target_length_std"] = trial.suggest_float("minus_end_target_length_std",
                                                                              *self.minus_end_target_length_std_range)
        ...
        synth_cfg = SyntheticDataConfig(
            ...
            minus_end_target_length_mean=self.minus_end_target_length_mean,
